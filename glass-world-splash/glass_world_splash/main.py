...
def splash_lock(self, **kw):
    ...
    self.display.root["IG_INITIAL_ANIMATE"] = {
        "steps": [
            ...
            {"window": w1, "atom": "IG_LAYER", "dst": "IG_LAYER_SPLASH"},
            {"window": w2, "atom": "IG_LAYER", "dst": "IG_LAYER_SPLASH_BACKGROUND"},
            {"window": self.display.root, "atom": "IG_VIEW_DESKTOP_VIEW", "dst": [0.0, 0.0, 1.0, height]},            
            {"tasks": [
                {"window": self.display.root, "atom": "IG_WORLD_ALPHA", "timeframe": 2.0, "dst": 1.0},
                {"window": self.display.root, "atom": "IG_WORLD_ZOOM", "timeframe": 2.0, "dst": 40.0},
                {"window": self.display.root, "atom": "IG_VIEW_DESKTOP_VIEW", "timeframe": 2.0, "dst": [-50.0, height * -50.0, 100.0, height * 100.0]}
            ]},
            {"tasks": [
                {"window": self.display.root, "atom": "IG_WORLD_LAT", "timeframe": 3.0, "dst": start_lat, "easing": "InCubic"},
                {"window": self.display.root, "atom": "IG_WORLD_LON", "timeframe": 3.0, "dst": start_lon, "easing": "InCubic"},
                {"window": self.display.root, "atom": "IG_WORLD_ZOOM", "timeframe": 3.0, "dst": 0.1, "easing": "OutCubic"}
            ]},
        ]
    }
    anim = self.display.root["IG_ANIMATE"]
