...
extern void action_resize_window_to_1_to_1_to_screen(View *view, Item *item);
...
extern void action_position_window(View *view, Item *item, float x, float y, float xalign, float yalign);
